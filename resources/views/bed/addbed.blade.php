...
<form accept-charset="utf-8" class=" rounded p-3" action="{{ url('admin/storebed') }}" method="POST">
    @csrf
   ...
   <div class="form-group pt-4">
    ...
    @error('patient') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
      ...
      <div class="form-group">
        ...
        <input type="time" name="alloted_time"  placeholder="Enter alloted_time" class="form-control"   />
        ...
        <div class="form-group">
            ...
            <input type="time" name="discharge_time"  placeholder="Enter discharge_time" class="form-control"   />
            @error('discharge_time') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
            </div>
    <div class="form-group">
        <input type="submit" class="btn btn-primary" value="Add bed">
    </div>
</form>
</div>
</div>
