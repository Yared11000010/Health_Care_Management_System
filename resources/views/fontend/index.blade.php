   ...
   <body class="clinic_version">
      ...
      <header>
         <div class="header-top wow fadeIn">
            <div class="container ">
               <a class="navbar-brand" href="index.html"><img src="{{ asset('/storage/setting/'.$settings->logo_path) }}" alt="image"></a>
               <div class="right-header">
                  <div class="header-info">
                     <div class="info-inner">
                        <span class="icontop"><img src="images/phone-icon.png" alt="#"></span>
                        <span class="iconcont"><a href="">{{ $settings->business_phone }}</a></span>	
                     </div>
                     <div class="info-inner">
                        <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        <span class="iconcont"><a data-scroll href="">{{ $settings->business_email }}</a></span>	
                     </div>
                     <div class="info-inner">
                        <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                        <span class="iconcont"><a data-scroll href="#">{{ $settings->working_horse }}</a></span>	
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        @auth
                           @if (auth()->user()->is_super_admin)
                               <li onclick="check_active('admin-area')"><a id="admin-area" data-scroll
                                       href="{{ route('maindashboard') }}">Admin Area</a></li>
                           @endif
                       @endauth
                       @guest
                           @if (Route::has('login'))
                       ...
                       <li onclick="check_active('Contact')"><a id="Contact" data-scroll
                           href="{{ url('adminlogout') }}">Logout</a></li>
                   @endguest
            ...
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        <span class="center"><span class="icon"><img src="{{ asset('/storage/setting/'.$settings->icon_logo_path) }}"  alt="#" /></span></span>
	  ...
	  <div id="doctors" class="parallax section db" data-stellar-background-ratio="0.4" style="background:#fff;" data-scroll-id="doctors" tabindex="-1">
		...
		<div class="heading">
               <span class="icon-logo"><img src="{{ asset('/storage/setting/'.$settings->icon_logo_path) }}"  alt="#"></span>
               <h2>The Specialist Clinic</h2>
            </div>
      ...
      <div id="getintouch" class="section wb wow fadeIn" style="padding-bottom:0;">
         ...
         <div class="contact-section">
            <div class="form-contant">
               <form  action="{{ url('admin/contact_us') }}" method="POST">
                  @csrf
                  <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="form-group in_email">
                              <input type="tel" class="form-control" id="phone" 
                                  placeholder="Phone" name="phone"  style="color: cyan">
                      ...
                      <div class="col-md-6">
                          <div class="form-group in_email">
                              <input type="text" class="form-control" id="subject" 
                                  placeholder="Subject" name="subject"  style="color: cyan">
                                  @error('subject') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
