            ...
            <ul class="mt-5 list-unstyled components text-secondary">
                ...
                <li>
                    <a href="#patients" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-user-circle  "></i> Patients Managements</a>
                ...
                <li>
                    <a href="#operations" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-object-group  "></i> Operation Reports</a>
                ...
                <li>
                    <a href="#birth" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-birthday-cake "></i> Birth Reports</a>
                ...
                <li>
                    <a href="#rooms" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-restroom "></i> Rooms Managements</a>
                ...
                <li>
                    <a href="#bill" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-money-bill "></i> Bill Managements</a>
                ...
                <li>
                    <a href="#bed" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-bed "></i> Bed Managements</a>
                ...
                <li>
                    <a href="#department" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle no-caret-down"><i class="fas fa-plane-departure "></i>Departments Managements</a>
                            ...
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right nav-link-menu">
                                    <ul class="nav-list">
                                        ...
                                        <li><a href="{{ url('admin/settings') }}" class="dropdown-item"><i class="fas fa-cog"></i> Settings</a>
                                        </li>
